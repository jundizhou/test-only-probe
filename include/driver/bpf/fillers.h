...
{
	struct net_dev_start_xmit_args *args;
	args = (struct net_dev_start_xmit_args*) data->ctx;
	struct sk_buff *skb;
	char dev_name[16] = {0};
...
{
	struct netif_receive_skb_args *args;
	args = (struct netif_receive_skb_args*) data->ctx;
	struct sk_buff *skb;
	char dev_name[16] = {0};
#ifdef BPF_SUPPORTS_RAW_TRACEPOINTS
	skb = args->skb;
